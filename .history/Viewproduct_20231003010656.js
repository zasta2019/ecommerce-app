...
const Viewproduct = (props) => {
  ...
  <TouchableOpacity
    ...
    style={[
      styles.tabcolorButton,
      selectedTab === String(index) && styles.selectedTabButton, // Use String(index) to match the index as a string
      { backgroundColor: data.colour },
    ]}
    onPress={() => handleTabPress(String(index))}
  >
    {/* You can display the color name or any other information here */}
