...
const Viewproduct = (props) => {
  ...
  if (!productId ) {
    // Product or product ID is undefined
    Alert.alert(
      'Product Not Found',
      'The product you are trying to access does not exist or the ID is undefined.',
      [
        {
          text: 'OK',
          onPress: () => {
            // Handle the OK button press if needed
            props.navigation.navigate('Home'); // Use props.navigation
          },
        },
      ],
      { cancelable: false }
    ...
    // You can also return null or render a loading spinner here
    return null;
  }
    ...
    <View style={{ marginTop: 30, backgroundColor: "white", flex: 1, }}>
      ...
      <ScrollView>
        ...
        <View style={styles.dotContainer}>
          {product&&product.productImageUrl.map.map((image, index) => (
