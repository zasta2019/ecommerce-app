...
const Viewproduct = (props) => {
 ...
 {product&&product.productImageUrl?.map((image, index) => (
        ...
        <View style={styles.content}>
          ...
          {product && product.colourAndSize ? (
  product.colourAndSize.map((data, index) => (
    <TouchableOpacity
      key={index}
      activeOpacity={0.6}
      style={[
    ...
    >
      <Text style={styles.colorText}>{data.colour}</Text>
    </TouchableOpacity>
  ))
) : (
  <Text>No color and size data available</Text>
)}
          ...
          {product &&
  product.colorAndSize &&
  product.colorAndSize.availableSizes.map((size, index) => (
    <View style={styles.customizebox} key={index}>
      <Text style={styles.customizeheading}>Select Size</Text>
      <View style={{ marginTop: 20 }}>
        <View style={styles.tabContainer}>
          {/* You can render the size value inside the tab button */}
          <TouchableOpacity
            activeOpacity={0.6}
            style={[
              styles.tabButton,
              selectedTab === size && styles.selectedTabButton,
            ]}
            onPress={() => handleTabPress(size)} // Pass the size value to handleTabPress
          >
            <Text style={styles.tabButtonText}>{size}</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
            ...
            <View style={{ marginTop: 20, }}>
              <View style={styles.tabContainer}>
                <TouchableOpacity activeOpacity={0.6}
                  ...
                  onPress={() => handleTabPress('8')}
                >
                  <Text style={styles.tabButtonText}>{product.fabric}</Text>
                </TouchableOpacity>
            ...
            <View style={{ marginTop: 20, }}>
              <View style={styles.tabContainer}>
                <TouchableOpacity activeOpacity={0.6}
                  ...
                  onPress={() => handleTabPress('11')}
                >
                  <Text style={styles.tabButtonText}>{product?.print}</Text>
                </TouchableOpacity>
          ...
          <View style={styles.customizebox}>
            ...
            <View style={{ marginTop: 10, }}>
              <Text style={styles.describe}>{product.productDescription}</Text>
            </View>
          </View>
          <View style={styles.customizebox}>
