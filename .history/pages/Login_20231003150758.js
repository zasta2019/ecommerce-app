...
export default function Login(props) {
  ...
  const [fontsLoaded]= useFonts({
    "Lato-Regular": require('.././assetsfont/Lato-Regular.ttf'),
    "Lato-Bold": require('.././assetsfont/Lato-Bold.ttf'),
  });
  ...
  return (
    ...
    <View>
      <View style={styles.flexrow}>
        <Image style={styles.logo} source={require('.././assetslogo.png')} />
  ...
  <Text style={styles.errorText}>{error}</Text>
        ...
        <View>
          <TouchableOpacity activeOpacity={0.6}>
            <Pressable style={[styles.socialbutton, styles.googleicon]}>
              <TouchableOpacity activeOpacity={0.6}>
                <Image source={require('.././assetsgoogle.png')} style={styles.socialicon} />
              </TouchableOpacity>
            </Pressable>
          </TouchableOpacity>
        </View>
        <View>
          <TouchableOpacity activeOpacity={0.6}>
            <Pressable style={styles.socialbutton}>
              <TouchableOpacity activeOpacity={0.6}>
                <Image source={require('.././assetsfacebook.png')} style={styles.facebookicon} />
              </TouchableOpacity>
            </Pressable>
          </TouchableOpacity>
        </View>
        <View>
          <TouchableOpacity activeOpacity={0.6}>
            <Pressable style={[styles.socialbutton, styles.appleicon]}>
              <TouchableOpacity activeOpacity={0.6}>
                <Image source={require('.././assetsapple.png')} style={styles.socialicon} />
              </TouchableOpacity>
            </Pressable>
          </TouchableOpacity>
        </View>
      ...
      <Image style={styles.leftcircle} source={require('.././assetsleft-circle.png')} />
    </View>
