  ...
  <Banner/>
     ...
     <View style={styles.productlisting}>
      {products&&products.map((product,index)=>(
             ...
             <Product productname={product.productName} category={product.categoryName} discount="-30%" discountprice="$799" actualprice="$999" imageSource={require("./assets/product.jpg")}/>
