...
export default function Login(props) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      setError(error.failure); // You can set a more descriptive error message
    }
  };
  ...
  return (
    ...
    <View>
      ...
      <View>
        ...
        <Text style={styles.textfield} onChangeText={setEmail}>E-mail </Text>
        <TextInput style={styles.inputfield} />
        <Text style={styles.textfield} onChangeText={setPassword}>Password</Text>
