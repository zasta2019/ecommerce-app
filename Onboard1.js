...
export default class Onboard1 extends React.Component {
  ...
  return (
    ...
    <ImageBackground source={require('./assets/screen1.jpg')} resizeMode="cover" style={styles.image}>
    ...
    <TouchableOpacity activeOpacity={0.6} onPress={() => this.props.navigation.navigate("Onboard2")}>
